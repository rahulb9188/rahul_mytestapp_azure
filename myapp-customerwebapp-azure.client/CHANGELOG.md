...
- Create Angular project with ng: `ng new myapp-customerwebapp-azure.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`myapp-customerwebapp-azure.client.esproj`).
